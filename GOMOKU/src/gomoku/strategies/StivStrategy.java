...
//
//    public List<BSquare> four = new ArrayList<>();
//
//    public List<List<BSquare>> openFours = new ArrayList<>();
//    public List<List<BSquare>> closeableFours = new ArrayList<>();
//
//
//
//
...
//                                break;
//                            }
//                            four.add(new BSquare(new Location(row, col), SimpleBoard.EMPTY));
//                            secondEmpty = true;
//                        }
...
//                        if (four.size() == 4 && !beginningEmpty && !secondEmpty) {
...
//                         100 & 101
//                        Case 5. &  6. .*/
//                        if (four.size() == 5 && beginningEmpty && !secondEmpty) {
//                            if (row + 1 < board.getWidth() && col + 1 < board.getHeight()) {
//                                if (b[row + 1][col + 1] == SimpleBoard.EMPTY) {
//                                    /* Case 6. 101 */
//                                    four.add(new BSquare(new Location(row, col), SimpleBoard.EMPTY));
...
//                        if (four.size() == 5 && secondEmpty && beginningEmpty) {
//                            if (row + 1 < board.getWidth() && col + 1 < board.getHeight()) {
//                                if (b[row + 1][col + 1] == SimpleBoard.EMPTY) {
//
//                                }
